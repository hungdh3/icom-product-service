...
-- CATEGORY-1
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('PRODUCT-NAME-1', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-1')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('PRODUCT-NAME-2', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-1')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('PRODUCT-NAME-3', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-1')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('PRODUCT-NAME-4', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-1')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('PRODUCT-NAME-5', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-1')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('PRODUCT-NAME-6', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-1')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('PRODUCT-NAME-7', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-1')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('PRODUCT-NAME-8', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-1')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('PRODUCT-NAME-9', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-1')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('PRODUCT-NAME-10', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-1')
);

-- CATEGORY-2
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('A', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-2')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('B', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-2')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('C', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-2')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('D', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-2')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('E', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-2')
);
-- CATEGORY-3
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('AA', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-3')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('BB', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-3')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('CC', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-4')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('DD', 'PRODUCT DESCRIPTION', current_timestamp,
        (select pc.PRODUCT_CATEGORY_ID from PRODUCT_CATEGORY pc where pc.PRODUCT_CATEGORY_NAME = 'CATEGORY-5')
);
insert into PRODUCT(PRODUCT_NAME, PRODUCT_DESCRIPTION, CREATED_AT, PRODUCT_CATEGORY_ID)
values ('EE', 'PRODUCT DESCRIPTION', current_timestamp,
